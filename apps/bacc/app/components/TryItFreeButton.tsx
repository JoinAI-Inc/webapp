    ...
    return (
        <Link
            ...
            className={twMerge(
                ...
                isPrimary
                    ? "border border-[#FFD322] bg-[#E8281E] text-white hover:shadow-[0_14px_32px_rgba(212,36,36,0.22)]"
                    : "border border-white bg-white text-[#CA1816] hover:shadow-[0_12px_30px_rgba(10,7,8,0.14)]",
                className
            )}
            style={{
        ...
        >
            ...
            <span className="relative z-10 inline-flex items-center gap-1.5">
                {label}
                <Image
                    src="/lucky-photo-home-cta-icon.svg"
                    alt=""
                    width={18}
                    height={18}
                    className="h-4 w-4 shrink-0 translate-y-[0.5px] tablet:h-[18px] tablet:w-[18px]"
                />
            </span>
        </Link>
    );
